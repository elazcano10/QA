...
//				boolean welcomeIsDisplayed = driver.findElement(By.id("welcome")).isDisplayed();
	...
	public void tc008() {
		...
		// Step 1 - Launch browser app
				...
				// Step 3 - Validate button Reset password
				boolean actualForgotMessage = driver.findElement(By.xpath("//*[@id='btnSearchValues']")).isDisplayed();
				Assert.assertTrue(actualForgotMessage);
